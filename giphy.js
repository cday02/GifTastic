var myGiffy = {
    ...
    myArray: ["bobs burgers", "gaming", "computers", "laughing", "coding", "dinosaurs"],
    userInput: "",
    ...
    doApiStuff: function(gifSelected) {
        ...
        $.ajax({
            type: "GET",
            url: "https://api.giphy.com/v1/gifs/search?q=" + gifSelected + "&api_key=npaXMObdvqk7wdEKaAwSPAG8E0VfeX3Z&limit=12"
